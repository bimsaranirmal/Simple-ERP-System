            ...
            <div class="form">
                ...
                <div class="form-group">
                    ...
                    <textarea id="customer-address" name="customer_address"
                        readonly><?php echo $invoice->customer_address; ?></textarea>
                </div>
                ...
                <div id="items-container">
                    <?php foreach ($invoice_items as $item): ?>
                        <div class="form-group item-row" style="display: flex; align-items: center; gap: 20px;">
                            ...
                            <div style="flex: 1;">
                                <label for="item-price">Item Price:</label>
                                <input type="text" name="item_price[]" class="item-price readonly"
                            ...
                            <div style="flex: 1;">
                                ...
                                <input type="text" name="total[]" class="total readonly" value="<?php echo $item->total; ?>"
                                    readonly>
                            </div>
