...
<body>
    ...
    <div class="container">
        ...
        <div class="view-buttons">
            <button id="formButton" class="view-button active">Add Unit</button>
            <button id="tableButton" class="view-button">View Units</button>
        </div>
        
        <div class="content-wrapper">
            <!-- Add Unit Form -->
            <div id="formContainer" class="form show">
                <form method="POST" action="<?php echo base_url('unit/save'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="unit_code" placeholder="Enter unit code" required>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <button type="button" onclick="deleteUnit('<?php echo $unit->id; ?>')" class="delete-btn">Delete</button>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
    ...
    <script>
        ...
        function deleteUnit(unitId) {
            if (confirm('Are you sure you want to delete this unit?')) {
                window.location.href = '<?php echo base_url("unit/delete/"); ?>' + unitId;
            }
        }
    </script>
</body>
